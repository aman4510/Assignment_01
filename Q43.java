...
public class Q43
{
	public static void main(String args[])
	{
		...
		for(int i=0; i<list.size(); i++)
		{
			...
			if(ep.getAge() <= age)
			{
				list1.add(ep.getName());
			}
			else
			{
				list2.add(ep.getName());
			}
		}
		
		System.out.println("Employees who's age is less than or equal to 21 are : " + list1);
		System.out.println("Employees who's age is greater than 21 are : " + list2);
	}
}